    ...
    Nothing -> do
      ...
      case mb' of
        ...
        Just c  -> do
          ...
          assembleDriver
  where
  assembleAsTextOrExtra :: Chunk arch -> Assembler arch m ()
  assembleAsTextOrExtra c = do
    extraStart <- St.gets asExtraStart
    case chunkAddress c < extraStart of
      True  -> assembleAsText c
      False -> assembleAsExtra c
